 ...
 * 
 * Props:
 * - userEmail: The email of the currently logged-in user.
 * - gatewayUrl: The URL of the Payment Gateway Backend (default: http://localhost:3000)
 */
const PaymentNotificationWidget = ({ userEmail, gatewayUrl = '/' }) => {
